...
% Round data to 3 sf
y1_BoP = round(0.1*[strt.TMS1_BoP(1:3)/strt.TMS1_pwr(2); sptn.TMS1_BoP(1:3)/sptn.TMS1_pwr(2)], ...
			3, 'significant');
y2_BoP = round(0.1*[strt.TMS2_BoP(1:2)/strt.TMS2_pwr(2); sptn.TMS2_BoP(1:2)/sptn.TMS2_pwr(2)], ...
			3, 'significant');
y3_BoP = round(0.1*[strt.TMS3_BoP/strt.TMS3_pwr(2); sptn.TMS3_BoP/sptn.TMS3_pwr(2)], ...
			3, 'significant');
y4_BoP = round(0.1*[strt.TMS4_BoP([1:2,4])/strt.TMS4_pwr(2); sptn.TMS4_BoP([1:2,4])/sptn.TMS4_pwr(2)], ...
			3, 'significant');
