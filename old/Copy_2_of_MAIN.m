...
%	outTMS(i)_Qdot [stkIn, PHOut, rjOut]		Stack in, Phtr out, RJ out [kW]
...
% Round data to 3 sf
y1_pwr  = round([strt.outTMS1_pwr(2); strt.outTMS2_pwr(2); strt.outTMS3_pwr(2); strt.outTMS4_pwr(2)], ...
	3, 'significant');
y2_pwr =  round([sptn.outTMS1_pwr(2); sptn.outTMS2_pwr(2); sptn.outTMS3_pwr(2); sptn.outTMS4_pwr(2)], ...
	3, 'significant');
% Bar colours and respective legend labels
c_pwr = c.yellow;
%l     = {'Stack', 'BoP', 'Total'};
% Plot data
plotBarData(outdir, y1_pwr, y2_pwr, c_pwr, 'Power consumption [kW]', ...
	'grouped', [], [], '1_totBoP', [], b_h, b_ar);
...
% Plot data
plotBarData(outdir, y1_BoP, y2_BoP, c_BoP, 'Power consumption [W]', ...
...
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% %%
function plotBarData(outdir_ch,y1,y2,c,yLabel,bartype,yLim,yScale,name,l, b_h, b_ar)
	% x-axis labels
